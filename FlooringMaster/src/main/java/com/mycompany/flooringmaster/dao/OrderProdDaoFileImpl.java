...
public class OrderProdDaoFileImpl implements OrderDao {
    ...
    public OrderProdDaoFileImpl() throws OrderPersistenceException {

        loadOrder(todayDate);

    }

    public OrderProdDaoFileImpl(LocalDate date) throws OrderPersistenceException {
            //   loadOrder(date);
...
//                List<Order> listOrder = this.getAllOrder();
...
//         List<Order> loadOrder= new ArrayList();
...
//        loadOrder(removeOrder.getOrderDate());
//        List<Order> orderList = new ArrayList();
//        if (orderMap.containsKey(removeOrder.getOrderDate())) {
