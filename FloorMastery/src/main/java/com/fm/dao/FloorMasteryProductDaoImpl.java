...
public class FloorMasteryProductDaoImpl implements FloorMasteryProductDao{

    private final String PRODUCTS_FILE;
    private final String DELIMITER = ",";

    private Map<String, Product> products = new HashMap<>();
	public FloorMasteryProductDaoImpl() {
    	PRODUCTS_FILE = "C:\\Users\\margi\\Desktop\\Workspace\\FloorMastery\\Data\\Products.txt";

	}



	public FloorMasteryProductDaoImpl(String vendingMachineTextFile) {
		PRODUCTS_FILE = vendingMachineTextFile;
	}

	@Override
	public List<Product> getAllProduct() throws FlooringMasteryProductPersistenceException {
		loadProducts();
		return new ArrayList<>(products.values());
	}

	@Override
	public Product getProduct(String productType) throws FlooringMasteryProductPersistenceException {
		loadProducts();
...
//	    }
	    ...
	    private void loadProducts() throws FlooringMasteryProductPersistenceException {
	        ...
	        try {
	            ...
	            throw new FlooringMasteryProductPersistenceException("");
	        }
	        String currentLine;
