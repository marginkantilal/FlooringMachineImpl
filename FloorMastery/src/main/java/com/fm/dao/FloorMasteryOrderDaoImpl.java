...
public class FloorMasteryOrderDaoImpl implements FloorMasteryOrderDao {
	    ...
	    @Override
	    public Order addOrder(Order order, String path) throws FlooringMasteryOrderPersistenceException  {
	        ORDER_FILE = path;
	        try {
	            loadOrdersAsListForAddingOrder();
	        } catch (IOException ex) {
	            throw new FlooringMasteryOrderPersistenceException("Error: Cannot open file.");
	        }
		...
		@Override
		public Order editOrder(Order newOrder, String path) throws FlooringMasteryOrderPersistenceException {
			 ORDER_FILE = path;
		        try {
		            loadOrdersAsList();
		        } catch (IOException ex) {
		...
		private void emptyFileHeader() throws FlooringMasteryOrderPersistenceException,IOException {
		...
		@Override
		public void exportOrder(String path) throws FlooringMasteryOrderPersistenceException {
		...
		@Override
		public List<Order> getAllOrder(String path) throws FlooringMasteryOrderPersistenceException {
		...
		@Override
	    public Order getOrder(int orderNumber, String path) throws FlooringMasteryOrderPersistenceException{
	        ORDER_FILE = path;
	        try {
	            loadOrdersAsList();
	        } catch (IOException ex) {
		...
		private void loadOrdersAsList() throws FlooringMasteryOrderPersistenceException, IOException {
	    	 ordersAsList.clear();
	         Scanner scanner;
	         try{
	             scanner = new Scanner(new BufferedReader(new FileReader(ORDER_FILE)));
	         } catch(FileNotFoundException e){
	             throw new FlooringMasteryOrderPersistenceException("Error: there is no file for the date");
	         }
	         String currentLine;
	         Order currentOrder;
		...
		private void loadOrdersAsListForAddingOrder() throws FlooringMasteryOrderPersistenceException, IOException { {
			 ordersAsList.clear();
		        Scanner scanner;
		        try{
		            scanner = new Scanner(new BufferedReader(new FileReader(ORDER_FILE)));
		...
		public void loadProduct() throws FlooringMasteryProductPersistenceException {
			 Scanner scanner;
		        try{
		            scanner = new Scanner(new BufferedReader(new FileReader(PRODUCT_FILE)));
		        } catch(FileNotFoundException e){
		            throw new FlooringMasteryProductPersistenceException("Could not load product data into memory.", e);
		        }
		...
		private void loadState() throws FlooringMasteryStatePersistenceException {
			Scanner scanner;
	        try{
	            scanner = new Scanner(new BufferedReader(new FileReader(TAX_FILE)));
	        } catch(FileNotFoundException e){
	            throw new FlooringMasteryStatePersistenceException("Could not load states data into memory.", e);
	        }
		...
		//Translate data from object in memory into a text file.
		 private String marshallOrderForExport(Order order, String date) throws FlooringMasteryOrderPersistenceException{
		 ...
		 private String marshallOrder(Order order) throws FlooringMasteryOrderPersistenceException{
			 String orderAsText = order.getOrderNumber() + DELIMITER;
				...
				@Override
		public Map<String, Product> productLog() throws FlooringMasteryProductPersistenceException {
			loadProduct();
			return products;
		}

		@Override
		public Order removeOrder(int orderNumber, String path) throws FlooringMasteryOrderPersistenceException, IOException {
			ORDER_FILE = path;
	        try {
	            loadOrdersAsList();
	        } catch (IOException ex) {
		...
		private int setOrderNumber() throws FlooringMasteryOrderPersistenceException {
		...
		@Override
		public Map<String, States> stateLog() throws FlooringMasteryStatePersistenceException {
			 loadState();
		     return states;
		}
		...
		private void writeOrder(List<Order> ordersAsList)throws FlooringMasteryOrderPersistenceException, IOException {
			 PrintWriter scanner;
		        try {
		            scanner = new PrintWriter(new FileWriter(ORDER_FILE));
		        } catch (FileNotFoundException e) {
		            throw new FlooringMasteryOrderPersistenceException( "-_- Could not load order data into memory.", e);
		        }
		...
		private void writeOrderFromList(List<Order> ordersAsList2) throws FlooringMasteryOrderPersistenceException, IOException {
			PrintWriter scanner;
	        try {
	            scanner = new PrintWriter(new FileWriter(ORDER_FILE));
	        } catch (FileNotFoundException e) {
		  ...
		  private void writeOrderFromListForExport(List<String> textData) throws FlooringMasteryOrderPersistenceException, IOException {
		        PrintWriter scanner;
		        try {
		            scanner = new PrintWriter(new FileWriter(ORDER_FILE));
		        } catch (FileNotFoundException e) {
